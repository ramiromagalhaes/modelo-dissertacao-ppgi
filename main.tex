...
\input{pre-textual/capa}                      % Editar o arquivo capa.tex
...
\input{pre-textual/resumoPortugues}           % Editar o arquivo resumoPortugues.tex
\input{pre-textual/resumoIngles}              % Editar o arquivo resumoIngles.tex
